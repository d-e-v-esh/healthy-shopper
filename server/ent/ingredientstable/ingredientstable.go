...
const (
	// Label holds the string label denoting the ingredientstable type in the database.
	Label = "ingredients_table"
	...
	EdgeProduct = "product"
	// Table holds the table name of the ingredientstable in the database.
	Table = "ingredients_tables"
	...
	ProductColumn = "ingredients_table_id"
)

// Columns holds all SQL columns for ingredientstable fields.
var Columns = []string{
	FieldID,
	FieldName,
	FieldDescription,
...
// OrderOption defines the ordering options for the IngredientsTable queries.
