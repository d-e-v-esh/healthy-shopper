...
func (olq *OrderLineQuery) FirstID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (olq *OrderLineQuery) FirstIDX(ctx context.Context) int {
...
func (olq *OrderLineQuery) OnlyID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (olq *OrderLineQuery) OnlyIDX(ctx context.Context) int {
...
func (olq *OrderLineQuery) IDs(ctx context.Context) (ids []int, err error) {
...
func (olq *OrderLineQuery) IDsX(ctx context.Context) []int {
	ids, err := olq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
//		GroupBy(orderline.FieldProductItemID).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
//
//	client.OrderLine.Query().
//		Select(orderline.FieldProductItemID).
//		Scan(ctx, &v)
